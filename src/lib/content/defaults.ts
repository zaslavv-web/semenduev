...
export const defaultContent: SiteContent = {
  ...
  about: {
    ...
    paragraphs: [
      "Антикризисный менеджер с 20-летним практическим опытом. Помогаю собственникам находить корневые причины проблем и формировать понятный план выхода из кризиса.",
    ],
    facts: [
      "20 лет практики антикризисного управления",
      "Основатель российского CreditExpress (оборот ~1 млрд ₽/год, EBITDA 3 млрд ₽)",
      "Кандидат экономических наук",
      "Работа в агрессивной бизнес-среде: долги, кассовые разрывы, кризисы роста",
      "Экспресс-диагностика бизнеса за 1 день",
      "Взгляд 360°: финансы, команда, процессы, рынок",
    ],
