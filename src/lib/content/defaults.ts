...
export const defaultContent: SiteContent = {
  ...
  about: {
    ...
    paragraphs: [
      "Антикризисный менеджер с 20-летним практическим опытом. В 2005 году основал российское подразделение CreditExpress, которое за 12 лет выросло в одного из лидеров рынка с оборотом почти 1 млрд рублей в год.",
